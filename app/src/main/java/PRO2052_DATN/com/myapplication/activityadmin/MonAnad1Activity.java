package PRO2052_DATN.com.myapplication.activityadmin;
...
import PRO2052_DATN.com.myapplication.adapter.RecyclerView_MonAnad;
import PRO2052_DATN.com.myapplication.model.Food;
...
public class MonAnad1Activity extends AppCompatActivity {
    ...
    public void dialog() {
        ...
        btnOKma.setOnClickListener(new View.OnClickListener() {
            ...
            // hàm push data (dữ liệu) lên Firebase
            public void uploadDaTatoFirebase(){
                if(mFilePathUri != null){
                    if(edtTenMA.getText().toString().isEmpty()){
                        ...
                        mProgressDialog.setTitle("Image is upload...");
                        //show dialog
                        mProgressDialog.show();
                        //create second storageReference ( Hàm khởi tạo StorageRefence )
                        ...
                        //adding addOnSucessListener to StorageReference ( Hàm addOnSuccessListener to StorageReference)
                                ...
                                storageReference2nd.getDownloadUrl().addOnSuccessListener(new OnSuccessListener
                                    ...
                                    public void onSuccess(Uri uri) {
                                        ...
                                        try {
                                            ...
                                            Toast.makeText(MonAnad1Activity.this, "Giá nhập Số", Toast.LENGTH_SHORT).show();
                                            mProgressDialog.dismiss();
                                        }
...
//
            ...
            // Phương thức chọn ảnh từ file path
...
//        });
    ...
    public void loadma(String categoriid){
        // chọn Food trên Firebase và trỏ đến categorid
    ...
    // hàm khởi tạo Show dialog Delete

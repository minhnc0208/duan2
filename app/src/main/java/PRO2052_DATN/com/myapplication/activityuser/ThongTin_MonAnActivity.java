    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(kiemtra){
                    Toast.makeText(ThongTin_MonAnActivity.this, "Thêm thành công ", Toast.LENGTH_SHORT).show();
//                    Intent intent= new Intent(ThongTin_MonAnActivity.this,CartActivity.class);
//                    startActivity(intent);

                }else {
                    Toast.makeText(ThongTin_MonAnActivity.this, "Thêm thất bại", Toast.LENGTH_SHORT).show();
                }
            }
        });
//        btnAddCart.setOnClickListener(new View.OnClickListener() {
